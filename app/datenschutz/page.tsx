  ...
  return (
    <Prose className="mb-8">
      ...
      <p>
        ...
        Seiten keine Kenntnis vom Inhalt der übermittelten Daten sowie deren Nutzung durch Facebook
      ...
      <p>
        ...
        erfasst und an Facebook weitergeleitet werden, sind wir und die Facebook Ireland Limited, 4
        ...
        Tools auf unserer Website verantwortlich. Für die Datensicherheit der Facebook-Produkte ist
        Facebook verantwortlich. Betroffenenrechte (z.B. Auskunftsersuchen) hinsichtlich der bei
      ...
      <p>
        ...
        gestützt. Details finden Sie hier:<span>&nbsp;</span>
      ...
      <p>
        ...
        Ireland Limited, 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Irland gemeinsam für
        diese Datenverarbeitung verantwortlich (Art. 26 DSGVO). Die gemeinsame Verantwortlichkeit
        beschränkt sich dabei ausschließlich auf die Erfassung der Daten und deren Weitergabe an
        Facebook bzw. Instagram. Die nach der Weiterleitung erfolgende Verarbeitung durch Facebook
        bzw. Instagram ist nicht Teil der gemeinsamen Verantwortung. Die uns gemeinsam obliegenden
        Verpflichtungen wurden in einer Vereinbarung über gemeinsame Verarbeitung festgehalten. Den
        Wortlaut der Vereinbarung finden Sie unter:<span>&nbsp;</span>
        <a href="https://www.facebook.com/legal/controller_addendum" target="_blank">
          https://www.facebook.com/legal/controller_addendum
        </a>
        . Laut dieser Vereinbarung sind wir für die Erteilung der Datenschutzinformationen beim
        ...
        Auskunftsersuchen) hinsichtlich der bei Facebook bzw. Instagram verarbeiteten Daten können
      ...
      <p>
        Diese Website nutzt Funktionen des Netzwerks LinkedIn. Anbieter ist die LinkedIn Ireland
      ...
      <p>
        Die Verwendung des LinkedIn-Plugins erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.
        Der Websitebetreiber hat ein berechtigtes Interesse an einer möglichst umfangreichen
        Sichtbarkeit in den Sozialen Medien. Sofern eine entsprechende Einwilligung abgefragt wurde,
        erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO; die
        Einwilligung ist jederzeit widerrufbar.
      ...
      <p>
        ...
        Datenschutzerklärung von Google:<span>&nbsp;</span>
      ...
      <p>
        ...
        und die Zeit von der Ansicht bis zum Kauf eines Produktes erfasst. Diese Daten können von
        Google unter einer Transaktions-ID zusammengefasst werden, die dem jeweiligen Nutzer bzw.
      ...
      <p>
        ...
        dieses Dienstes ist die Facebook Ireland Limited, 4 Grand Canal Square, Dublin 2, Irland.
        Die erfassten Daten werden nach Aussage von Facebook jedoch auch in die USA und in andere
        Drittländer übertragen.
      </p>
      <p>
      ...
      <p>
        ...
        und Facebook die Daten für eigene Werbezwecke, entsprechend der<span>&nbsp;</span>
        <a href="https://de-de.facebook.com/about/privacy/" target="_blank">
          Facebook-Datenverwendungsrichtlinie
        </a>
        <span>&nbsp;</span>verwenden kann. Dadurch kann Facebook das Schalten von Werbeanzeigen auf
        Seiten von Facebook sowie außerhalb von Facebook ermöglichen. Diese Verwendung der Daten
      ...
      <p>
        ...
        <span>&nbsp;</span>deaktivieren. Dazu müssen Sie bei Facebook angemeldet sein.
      </p>
      <p>
      ...
      <p>
        ...
        Newsletterverteilerliste gelöscht. Wir behalten uns vor, E-Mail-Adressen aus unserem
      ...
      <p>
        ...
        zeitlich nicht befristet.<span>&nbsp;</span>
        <strong>
      ...
      <p>
        ...
        <span>&nbsp;</span>und in der Datenschutzerklärung von Google:<span>&nbsp;</span>
        <a href="https://policies.google.com/privacy?hl=de" target="_blank">
          https://policies.google.com/privacy?hl=de
        </a>
        .
      ...
      <h3>Adobe Fonts</h3>
      <p>
        Diese Website nutzt zur einheitlichen Darstellung bestimmter Schriftarten Web Fonts von
        Adobe. Anbieter ist die Adobe Systems Incorporated, 345 Park Avenue, San Jose, CA
        95110-2704, USA (Adobe).
      </p>
      <p>
        Beim Aufruf dieser Website lädt Ihr Browser die benötigten Schriftarten direkt von Adobe, um
        ...
        Ihre IP-Adresse diese Website aufgerufen wurde. Bei der Bereitstellung der Schriftarten
        werden nach Aussage von Adobe keine Cookies gespeichert.
      </p>
      <p>
        Die Speicherung und Analyse der Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.
      ...
      <p>
        Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission
        gestützt. Details finden Sie hier:<span>&nbsp;</span>
        <a href="https://www.adobe.com/de/privacy/eudatatransfers.html" target="_blank">
          https://www.adobe.com/de/privacy/eudatatransfers.html
        </a>
        .
      </p>
      <p>
        Nähere Informationen zu Adobe Fonts erhalten Sie unter:<span>&nbsp;</span>
        <a href="https://www.adobe.com/de/privacy/policies/adobe-fonts.html" target="_blank">
          https://www.adobe.com/de/privacy/policies/adobe-fonts.html
        </a>
        .
      </p>
      <p>
        Die Datenschutzerklärung von Adobe finden Sie unter:<span>&nbsp;</span>
      ...
      <p>
        ...
        und den Google Nutzungsbedingungen unter folgenden Links:<span>&nbsp;</span>
        <a href="https://policies.google.com/privacy?hl=de" target="_blank">
          https://policies.google.com/privacy?hl=de
        </a>
        <span>&nbsp;</span>und<span>&nbsp;</span>
      ...
      <p>
        ...
        gestattet. Personenbezogene Daten über die Inanspruchnahme dieser Website (Nutzungsdaten)
      ...
      <p>
        Wir binden Zahlungsdienste von Drittunternehmen auf unserer Website ein. Wenn Sie einen Kauf
        ...
        jeweiligen Anbieter. Der Einsatz der Zahlungsdienstleister erfolgt auf Grundlage von Art. 6
        Abs. 1 lit. b DSGVO (Vertragsabwicklung) sowie im Interesse eines möglichst reibungslosen,
      ...
      <p>
        Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission
        gestützt. Details finden Sie hier:<span>&nbsp;</span>
        <a href="https://www.paypal.com/de/webapps/mpp/ua/pocpsa-full" target="_blank">
          https://www.paypal.com/de/webapps/mpp/ua/pocpsa-full
        </a>
        .
      </p>
      <p>
        Details entnehmen Sie der Datenschutzerklärung von PayPal:<span>&nbsp;</span>
      ...
      <p>
        ...
        <span>&nbsp;</span>und<span>&nbsp;</span>
        <a href="https://stripe.com/de/guides/general-data-protection-regulation" target="_blank">
